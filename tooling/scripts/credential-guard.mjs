...
const TOKEN_PATTERNS = [
  ...
  { category: 'provider-token', pattern: /\b(?:ghp_[A-Za-z0-9]{30,}|github_pat_[A-Za-z0-9_]{30,}|xox[baprs]-[A-Za-z0-9-]{20,}|sk-(?:live|proj)-[A-Za-z0-9_-]{20,}|smk_[A-Za-z0-9_-]{20,})\b/g },
